...
namespace CalculateMoney.Controllers
{
    ...
    {
        [HttpPost]
        public IActionResult PostData([FromBody] List<InputModel> data, [FromQuery] CurrencyNames currency,string name=null)
        {
            ...
            if(name!=null)
             client.GetStringAsync
                ($"http://historyservice:8080/History/SaveData?name={name}&str={HistoryBuilder}");
            return Ok(result + "");
        }
